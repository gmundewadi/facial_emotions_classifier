...
#load model
model = model_from_json(open("../ConvNet/fer.json", "r").read())
#load weights
model.load_weights('../ConvNet/fer.h5')


face_haar_cascade = cv2.CascadeClassifier('../ConvNet/haarcascade_frontalface_default.xml')
